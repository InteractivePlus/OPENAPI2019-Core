...
namespace BoostPHP\MySQL{
	...
	class MySQL{
		 ...
		 */
		public static function connectDB(string $Username, string $Password, string $Database, string $Host = "127.0.0.1", int $Port = 3306){
		 ...
		 */
		public static function checkExist($MySQLiConn,string $Table,array $SelectRequirement) : int{
		 ...
		 */
		public static function insertRow($MySQLiConn, string $Table, array $InsertArray) : bool{
		 ...
		 */
		public static function updateRows($MySQLiConn, string $Table, array $UpdateArray, array $SelectRequirement) : bool{
		 ...
		 * @return bool - if succeed, return true.
		 */
		public static function deleteRows($MySQLiConn, string $Table, array $SelectRequirement) : bool{
