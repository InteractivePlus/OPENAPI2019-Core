...
namespace BoostPHP\Encryption{
    ...
    class AES{
        ...
        public static function encryptECB($textToEncode, $password, $bit = 256){
        ...
        public static function decryptECB($textToDecode, $password, $bit = 256){
            if($bit != 128 && $bit != 192 && $bit != 256){
                throw new Exception("Encryption bit can only be 128, 192 or 256!");
            }
            if(AES::$isOpenSSL && AES::$eachEncryptionOpenSSL["ECB"]){
        ...
        public static function encryptCFB8($textToEncode, $password, $bit = 256){
            if($bit != 128 && $bit != 192 && $bit != 256){
                throw new Exception("Encryption bit can only be 128, 192 or 256!");
            }
        ...
        public static function decryptCFB8($textToDecode, $password, $bit = 256){
            if($bit != 128 && $bit != 192 && $bit != 256){
                throw new Exception("Encryption bit can only be 128, 192 or 256!");
            }
        ...
        public static function encryptCBC($textToEncode, $password, $bit = 256){
            if($bit != 128 && $bit != 192 && $bit != 256){
                throw new Exception("Encryption bit can only be 128, 192 or 256!");
            }
        ...
        public static function decryptCBC($textToDecode, $password, $bit = 256){
            if($bit != 128 && $bit != 192 && $bit != 256){
                throw new Exception("Encryption bit can only be 128, 192 or 256!");
            }
        ...
        public static function encryptOFB($textToEncode, $password, $bit = 256){
            if($bit != 128 && $bit != 192 && $bit != 256){
                throw new Exception("Encryption bit can only be 128, 192 or 256!");
            }
        ...
        public static function decryptOFB($textToDecode, $password, $bit = 256){
            if($bit != 128 && $bit != 192 && $bit != 256){
                throw new Exception("Encryption bit can only be 128, 192 or 256!");
            }
